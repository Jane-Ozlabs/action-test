                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                ...
                                                @click="viewWithdrawalLog(detail)"
                                                >Detail</a
                                            >
                                        </td>
                                    </tr>
...
export default {
    ...
    data() {
        return {
            ...
            items: [
                { text: "User", href: "/user/user" },
                { text: "User", href: "/user/user" },
                { text: "User Detail", href: "/user/user/" + this.$route.params.id },
            ],
            detail: {},
        };
    },
