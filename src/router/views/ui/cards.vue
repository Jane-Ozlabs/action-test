...
<template>
  <Layout>
    ...
    <div class="row">
      <div class="col-md-4">
        <b-card bg-variant="primary" class="text-white" header-class="bg-primary">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
              <i class="mdi mdi-bullseye-arrow mr-3"></i> Primary Card
            </h5>
          </template>
          <b-card-title>
            <h5 class="card-title font-size-16 mt-0">card title</h5>
          </b-card-title>
          <p
      ...
      <div class="col-md-4">
        <b-card bg-variant="success" class="text-white" header-class="bg-success">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
      ...
      <div class="col-md-4">
        <b-card bg-variant="info" class="text-white" header-class="bg-info">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
    ...
    <div class="row">
      <div class="col-md-4">
        <b-card bg-variant="warning" class="text-white" header-class="bg-warning">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
      ...
      <div class="col-md-4">
        <b-card bg-variant="danger" class="text-white" header-class="bg-danger">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
      ...
      <div class="col-md-4">
        <b-card bg-variant="dark" class="text-white" header-class="bg-dark">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
    ...
    <div class="row">
      <div class="col-lg-4">
        <b-card header-class="border-primary" class="border text-primary border-primary">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
      ...
      <div class="col-lg-4">
        <b-card header-class="border-danger" class="border text-danger border-danger">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
      ...
      <div class="col-lg-4">
        <b-card header-class="border-success" class="border text-success border-success">
          <template v-slot:header>
            <h5 class="font-size-16 my-0">
              <i class="mdi mdi-check-all mr-3"></i>Success outline Card
            </h5>
          </template>
          <h5 class="card-title mt-0">card title</h5>
          <p
