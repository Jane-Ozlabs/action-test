...
export default {
  ...
  components: { Layout, Header, PageHeader, AgentFilter, MonthFilter, UserFilter, MonthlyView, Pagination, UserMonthView },
  data() {
    return {
      title: "월별 매출 현황",
      items: [],
  ...
  methods: {
    async load() {
      ...
      this.rows = [];
      var res = await loadPagedView(this, "/partners/views/revenue/monthly", {});
