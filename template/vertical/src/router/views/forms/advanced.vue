      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted">Examples of bootstrap fileStyle.</p>

            <b-form-group label="Default file input" label-for="file">
              <b-form-file
                id="file"
                v-model="file"
                :state="Boolean(file)"
            ...
            <!-- Plain mode -->
            <b-form-group label="File style without input" label-for="plain-demo">
              <b-form-file id="palin-demo" v-model="file2" class="mt-3" plain></b-form-file>
            </b-form-group>
          </div>
        </div>
      </div>
